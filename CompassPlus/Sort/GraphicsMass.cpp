...
void sortSelection(int* arr, int i, int compArr[SORT_COUNT][N], int assignArr[SORT_COUNT][N]);
void sortBubble(int* arr, int i, int compArr[SORT_COUNT][N], int assignArr[SORT_COUNT][N]);
void sortInsert(int* arr, int i, int compArr[SORT_COUNT][N], int assignArr[SORT_COUNT][N]);
...
void sortInserts(int* arr, int i, int compArr[SORT_COUNT][N], int assignArr[SORT_COUNT][N])
{
    int s = 0;
    int p = 0;
...
void sortBubbles(int* arr, int i, int compArr[SORT_COUNT][N], int assignArr[SORT_COUNT][N])
{
    int s = 0;
    int p = 0;
    int t;
    ...
    */
    for(int i = 0; i < 2; i++)
    {
        for(int j = 0; j < 3; j++)
        {
            ...
            {
                drawGraph(100 + i * 450, 475 + j * 250, arr2, i + 1);
            }
            else
            {
                drawGraph(100 + i * 450, 475 + j * 250, arr3, i + 1);
            }
        }
    }
}
