...
{
    SelectObject(hdc, CreatePen(PS_SOLID,  8, RGB(41, 243, 15)));
...
{
    SelectObject(hdc, CreatePen(PS_SOLID,  8, RGB(241, 43, 115)));
    Ellipse(hdc, 300, 300, 325, 325);
}

void Game::drawStrongUnit(HDC hdc)
{
    SelectObject(hdc, CreatePen((PS_SOLID), 8, RGB(40, 102, 249)));
