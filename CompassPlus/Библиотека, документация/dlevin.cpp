...
void Running(int faceX0, int faceY0,  int meetTimeS, int meetX, int meetY)
{
        ...
        while (i < meetTimeS)
      {
        ...
        txTextOut(50, 480, "        Похоже я опять промазал!");
        ...
        txSetColor(TX_BLACK);
        txSelectFont("Arial", 20);
        txTextOut(5, 25, "Похоже он опять промазал!");
        txTextOut(5, 45, "      Надо выручать");
        txSleep (5000);
...
void BallFlight(int faceX0, int faceY0, int face2X0, int face2Y0, int face3X0, int face3Y0, int face4X0, int face4Y0, int meetTimeS, int meetX, int meetY)
{
        ...
        while (k < 210)
   {
        ...
        drawHappysmile(face3X0 + k *0.5, face3Y0 - k * 0.5, 20, TX_BLUE, TX_BLACK, 5, TX_BLACK , TX_GREEN);//слева снизу
...
void Celebration(int faceX0, int faceY0, int face2X0, int face2Y0, int face3X0, int face3Y0, int face4X0, int face4Y0, int meetTimeS, int meetX, int meetY)
{
    ...
    while (n++ < meetTimeS)
    {
        ...
        drawSadsmile(face2X0 + n * (meetX - face2X0) / meetTimeS + 30 * sin(n / 5.0), face2Y0 + n * (meetY - face2Y0) / meetTimeS, 20, TX_YELLOW, TX_BLACK, 5, TX_BLUE , TX_RED);//справа сверху
        drawHappysmile(face3X0 + n * (meetX - face3X0) / meetTimeS + 30 * sin(n / 5.0), face3Y0 + n * (meetY - face3Y0) / meetTimeS, 20, TX_BLUE, TX_BLACK, 5, TX_BLACK , TX_GREEN);//слева снизу
...
void Jumping(int faceX0, int faceY0, int face2X0, int face2Y0, int face3X0, int face3Y0, int face4X0, int face4Y0, int meetTimeS, int meetX, int meetY)
{
    ...
    while (m++ < meetTimeS)
    {
        ...
        drawHappysmile(face3X0 + m * (meetX - face3X0) / meetTimeS + 50 * sin(m / 5.0), face3Y0 + m * (meetY - face3Y0) / meetTimeS, 20, TX_BLUE, TX_BLACK, 5, TX_BLACK , TX_GREEN);//слева снизу
