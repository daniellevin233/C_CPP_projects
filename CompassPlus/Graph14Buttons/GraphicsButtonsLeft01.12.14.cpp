...
int main()
{
    ...
    while (!GetAsyncKeyState(VK_ESCAPE))
    {
        ...
        drawGrid();
        drawGraph();
        drawRightButton(buttonRightX, buttonRightY, buttonRightW, buttonRightH,
                   buttonRightText, buttonRightUnderCursor, buttonRightPressed);
        drawLeftButton(buttonLeftX, buttonLeftY, buttonLeftW, buttonLeftH,
...
{
    RECT buttonRightRect = {buttonRightX, buttonRightY, buttonRightX + buttonRightW, buttonRightY + buttonRightH};
...
{
    RECT buttonLeftRect = {buttonLeftX, buttonLeftY, buttonLeftX + buttonLeftW, buttonLeftY + buttonLeftH};
...
void drawLeftButton(int x, int y, int w, int h,
                char* text, bool underCursor, bool pressedLeft)
{
    int delta = 0;
    if (underCursor && pressedLeft)
    {
        txSetColor(TX_BLACK, 3);
        delta = 2;
    }
