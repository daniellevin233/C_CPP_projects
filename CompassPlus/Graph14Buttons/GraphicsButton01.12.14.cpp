...
void returnButtonRight(int x, int y, int w, int h, char* text);

void drawLeftButton(int x, int y, int w, int h,
                char* text, bool underCursor, bool pressed);
void returnButtonLeft(int x, int y, int w, int h, char* text);
                ...
                char* text, bool underCursor, bool buttonLeftPressed)
{
    ...
    {
        returnButtonRight(int x, int y, int w, int h, char* text);
        txSetColor(TX_BLACK, 3);
        delta = 2;
    }
    else
...
void returnButtonRight(int x, int y, int w, int h, char* text)
{
    txSetColor(TX_BLACK);
    txSetFillColor(TX_WHITE);
    txRectangle(x - 2, y - 2 , x + w - 2, y + h - 2);
    txDrawText(x, y, x + w, y + h, text);
}
void returnButtonLeft(int x, int y, int w, int h, char* text)
{
