 ...
 * should be made. Blocking a thread in BLOCKED _state has no
 ...
 * it to the READY _state if it's not synced. Resuming a thread in a RUNNING or READY _state
 ...
 * ID tid was in RUNNING _state. On the first time a thread runs, the function
 * should return 1. Every additional quantum that the thread starts should
 * increase this value by 1 (so if the thread with ID tid is in RUNNING _state
